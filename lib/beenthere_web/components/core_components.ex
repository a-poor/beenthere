defmodule BeenthereWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BeenthereWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BeenthereWeb.Gettext, "errors", msg, opts)
    end
  end
